...
class TestLibretroAnalogMode(unittest.TestCase):
    def test_padtype_only_btn(self):
        basicControllerBTN = controllersConfig.Controller("contr1", "joypad", "GUID1", "0", "Joypad1RealName",
                                                          onlyBtnsInputs)
        padtype = libretroControllers.getAnalogMode(basicControllerBTN)
    ...
    def test_padtype_only_joystick(self):
        basicController = controllersConfig.Controller("contr1", "joypad", "GUID1", "0", "Joypad1RealName",
                                                       onlyAxisInputs)
        padtype = libretroControllers.getAnalogMode(basicController)
