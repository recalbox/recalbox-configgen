...
class TestControllersConfig(unittest.TestCase): 
	...
	players = controllersConfig.loadControllerConfig(-1, uuid, "p1controller", -1, uuid, "p2controller", -1, uuid, "p3controller", -1, uuid, "p4controller")
    ...
    def test_associate_controllers_with_players_with_diferentuuid(self):
	uuid1 = "060000004c0500006802000000010000"
	uuid2 = "030000005e0400008e02000014010000"
	players = controllersConfig.loadControllerConfig(-1, uuid1, "p1controller", -1, uuid2, "p2controller", -1, uuid2, "p3controller", -1, uuid2, "p4controller")
	self.assertEquals(4, len(players))
	...
	uuid1 = "060000004c0500006802000000010000"
	players = controllersConfig.loadControllerConfig(0, uuid1, "p1controller", -1, "FAKEUUID", "DEFAULTNAME", -1, "FAKEUUID", "DEFAULTNAME", -1, "FAKEUUID", "DEFAULTNAME")
